...
export default observer class OrdersByAddress2View extends Component
  renderAddressOrders: =>
    @props.addressOrders.map (addressOrder, index) =>
      <View key={index} style={{ flexDirection: 'row', height: 55, borderBottomWidth: 1, borderBottomColor: '#a6a6a6' }}>
