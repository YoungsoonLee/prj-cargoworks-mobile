export default observer class OrderGetSetting extends Component
  constructor: (props) ->
    super props
  ...
  renderDistances: =>
    ...
    distances.unshift <Picker.Item key={0} value="상관없음" label="상관없음" />
        ...
        <View style={{ flexDirection: 'row', flexWrap: 'wrap', marginRight: 5, paddingBottom: 5 }}>
          ...
          <View style={{ flexDirection: 'row' }}>
            ...
            <View style={{ flex: 1, justifyContent: 'flex-end' }}>
              <Button name="추레라" onPress={@onPressVehicle} paddingHorizontal={0} textSize={15} color={if '추레라' in @state.vehicles then 'blue' else 'white'} width={@vehicleItemWidth} height={45} marginLeft={5} marginTop={5}>추레라</Button>
            </View>
          </View>
        </View>
